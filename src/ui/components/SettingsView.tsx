...
import { Settings, Zap, Phone, Mail, CheckCircle2, MessageSquare, TrendingUp, AlertCircle, Loader2, QrCode, Wifi, WifiOff, ChevronDown, RefreshCcw, Plus, Trash2, Pencil, X, Check, ShoppingBag, Monitor, ExternalLink } from 'lucide-react';
